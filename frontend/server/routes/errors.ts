...
<html lang="en" data-bs-theme="light">
  ...
  <body>
    <nav class="navbar navbar-expand-lg bg-body-tiary">
      <div class="container">
        <a class="navbar-brand fw-bold" href="/">SuperNetworkAI</a>
        <div class="ms-auto d-flex gap-2">
          <a href="/login" class="nav-link">Log in</a>
    ...
    <main class="container d-flex justify-content-center align-items-center min-vh-100">
      <div class="card text-center" style="max-width: 500px;">
        <div class="card-body py-5">
          ...
          <p class="text-muted small mb-4">Please try again later or <a href="/dashboard" class="alert-link">return to the dashboard</a>.</p>
        </div>
      </div>
    </main>
  </body>
